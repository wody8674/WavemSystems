...
function fn_search() {
	$.ajax({
		type : "get",
		url : "/SpringProject/getSession.do",
		data : "",
		dataType : "text",
...
//	alert($("#form").serialize());
	...
	$.ajax({
		type : "POST",
		url : "/SpringProject/login.do",
		data : "",//$("#form").serialize(), //태그에 name 필요,
		dataType : "text",
		success : function(data) {
			fn_loginProcess(data);
		},
		complete : function(xhr, textStatus) {
		},
		error : function() {
